...
datasets=( /MET/Run2017B-31Mar2018-v1/MINIAOD
...
farmoutAnalysisJobs \
 ...
 ${dirName[$index]} \
 /cms/gomber/ggntulizer/MonoHiggs_Tau2017tuples/CMSSW_9_4_9/ \
 /cms/gomber/ggntulizer/MonoHiggs_Tau2017tuples/CMSSW_9_4_9/src/ggAnalysis/ggNtuplizer/test/run_data2017_94X_fmout.py
