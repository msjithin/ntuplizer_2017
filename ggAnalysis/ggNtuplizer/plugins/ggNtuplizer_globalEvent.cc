...
void ggNtuplizer::fillGlobalEvent(const edm::Event& e, const edm::EventSetup& es) {
  ...
  for (size_t i = 0; i < trgNames.size(); ++i) {
    ...
    if (year_ == 2017) {
      ...
      else if (name.find("HLT_DoubleTightChargedIsoPFTau35_Trk1_TightID_eta2p1_Reg_v")       != string::npos) bitEleMuX = 29;
      else if (name.find("HLT_DoubleMediumChargedIsoPFTau40_Trk1_TightID_eta2p1_Reg_v")       != string::npos) bitEleMuX = 30;
      else if (name.find("HLT_DoubleTightChargedIsoPFTau40_Trk1_eta2p1_Reg_v")                 != string::npos) bitEleMuX = 31;
